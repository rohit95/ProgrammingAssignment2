...
## if the matrix has been cached before, the inverse of a matrix will be 
## returned right now rather than compute it repeatedly.
...
## “matrix” created with the above function, but it first checks to see 
## if the inverse of the matrix has already been calculated. If so, it gets 
